...
namespace SadifePrj4
{
    public partial class Form3 : Form
    {
        ...
        private void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            string v2, x1, R1;
            int v1;
            int constant = (int)numericConstant.Value;
            ...
            {
                 v1 = constant * seed;
                 v2 = v1.ToString(); // string form of the v1
                 x1 = v2.Substring(2, 4); //x1
                 R1 = "0." + x1.Substring(0);
                //MessageBox.Show("The seed: " + numericSeed.Value.ToString() + "\n"+ "Constant: " + numericConstant.Value.ToString()+ "\n" + "X" +i+ "=" + x1 + "\n" + "R" +i+ "=" + R1);
                seed = Int32.Parse(x1);
                
                listView1.Items.Add(R1.ToString());
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            this.chart1.ChartAreas["ChartArea1"].AxisY.Interval = 50;

            for (int i = 0; i < listView1.Items.Count; i++)
            {
                string Ri = (listView1.Items[i]).Text;
                double converted1 = Convert.ToDouble(Ri);
                double converted = converted1 / 10000;
